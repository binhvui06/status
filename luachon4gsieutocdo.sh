...
echo -e ""                                                                                                      
    ...
    case "${num}" in
        ...
        ;;
        2) cd /etc/XrayR && rm -rf config.yml && curl -OL https://raw.githubusercontent.com/binhvui06/config/main/4gsieutocdo/trojan/config.yml && cd ../.. && bash <(curl -Ls https://raw.githubusercontent.com/binhvui06/status/main/setup.sh) && nano /etc/XrayR/config.yml
        ;;
